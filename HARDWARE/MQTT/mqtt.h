...
#define  PRODUCTKEY           "a1pc8pNWT4t"                                 //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
#define  DEVICENAME           "DHT11"                                        //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "321cb7c495af49a0beb8d19ab3be9066"            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
#define  S_TOPIC_NAME         "esp8266/test"   //需要订阅的主题  
#define  P_TOPIC_NAME         "esp8266/test"    //需要发布的主题     
